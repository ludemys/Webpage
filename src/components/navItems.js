...
class NavItems extends Component
{
    ...
    render = () =>
    {
        ...
        return (
            <Fragment>
                <li className='item'><a onClick={() => this.handleClick(1)} className="link">Home</a></li>
                <li className='item'><a onClick={() => this.handleClick(2)} className="link">Who I am</a></li>
                <li className='item'><a onClick={() => this.handleClick(3)} className="link">Portfolio</a></li>
                <li className='item'><a onClick={() => this.handleClick(4)} className="link">Goals</a></li>
                <li className='item'><a onClick={() => this.handleClick(5)} className="link">Contact</a></li>
            </Fragment>
        )
    }
}
