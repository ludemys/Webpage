...
const Portfolio = () =>
{
    return(
        <div className="portfolio">
            ...
            <a className="link github-link" href="https://www.github.com/ludemys" target="_blank"rel="noreferrer">
                <article className="github-card">
                    ...
                    <img className="github-profile" src="https://avatars.githubusercontent.com/u/52580686?v=4" alt="github profile" />
