    ...
    render = () =>
    {
        return (
            <section className="goals">
                ...
                <div className="todo-item">
                    <img src="./assets/twitter.png" className="image" />
                ...
                <div className="todo-item">
                    ...
                    <img src="https://production-tcf.imgix.net/app/uploads/2020/03/20155636/dudley_opm-01.png?auto=format%2Ccompress&q=80&fit=crop&w=1200&h=600" className="image" />
                </div>
